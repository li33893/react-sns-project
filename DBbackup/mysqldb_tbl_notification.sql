...
CREATE TABLE `tbl_notification` (
  ...
  `notificationType` enum('follow','feed_like','feed_comment','feed_favorite','comment_reply','app_approved','app_rejected','app_submitted','activity_reminder','leader_confirmation','new_follower','route_update') NOT NULL,
