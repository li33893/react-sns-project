...
- [개인 경험] 상담 영역 종사자들은 대부분 사회가 정의하는 "정상"의 혜택을 누리며 살아온 사람들이지만, 환자는 정반대->본인이 환자를 이해하려고 아무리 노력해도 자기도 모르게 "당연시"한 관념들이 가로막을 때가 많지만 환자는 그것을 정확히 느낄 수 있음
- [개인 경험] 어떤 원인으로 사회가 원활한 소통을 위해 "정상"의 기준을 명확히 하고 의료화가 과도하여 의료자원 공급이 더욱 긴장해지는 동시에 사람들은 자기와 서로를 유형화하려 함. 그러나 인간은 매우 복잡한 존재로서 각자 독특하고 심오한 사고, 욕구, 성격, 행동 패턴을 지니고 있으며, 이러한 복잡함 자체가 가치 있음
