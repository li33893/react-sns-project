...
- 저소득층은 긴 대기시간, 높은 비용, 중산에게 그래도 감당하는 약물 부작용이 이들에게는 파괴적일 수 있음
- 운동은 간단하게 보이지만 실은 아주 강력한 항우울 솔루션, 많은 연구에서 운동을 우울증 핵심 치료법으로 권고
- **서비스 설계**: 
...
- 낙인 두려움으로 도움 요청 어려움, 주변 사람도 낙인 때움에 조심스러워 함
