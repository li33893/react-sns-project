...
<div style="border:1px solid #ccc; padding:10px; font-size:smaller; border-radius:5px; background-color:#f9f9f9;">
   ...
   <b>[역할]</b><br>
   - 전반부: 자신이 주자, 이전 사람이 동반자<br>
   - 후반부: 자신이 동반자, 다음 사람이 주자<br>
   - → 각 개인에게 전반부 역할은 주자, 후반부 역할은 동반자임<br><br>
   
   <b>[릴레이 방법]</b><br>
   - 이전 사람이 중간 지점에 도달하면 다음 사람과 합류 → 릴레이 버튼 누름<br>
   - 버튼 누르는 순간: 다음 사람 타이머 시작, 이전 사람은 동반자, 다음 사람은 주자가 되어 두 사람이 함께 달림<br>
   - → 다음 사람이 버튼 누를 때 이전 사람은 자신의 달리기 임무 완료, 반복<br><br>
