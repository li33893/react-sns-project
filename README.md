...
**현황:**
- "왜 (너만) 이렇게 되었는가"에만 집중하고 "당신은 누구인가","무엇을 하고 싶은가","무엇을 할 수 있는가"는 무시되는 보편 현상
- 낙인 두려움으로 도움 요청 어려움, 주변 사람도 낙인 때문에 조심스러워 함
- [개인 경험] 상담 영역 종사자들은 대부분 사회가 정의하는 "정상"의 혜택을 누리며 살아온 사람들이지만, 환자는 정반대->본인이 아무리  환자를 이해하려고 노력해도 자기도 모르게 "당연시"한 관념들이 가로막을 때가 많은데 환자는 그것을 정확히 느낄 수 있음
- [개인 경험] 사회는 원활한 소통을 위해 "정상"의 기준을 해마다 더욱 명확히 하려 하고, 과도한 의료화로 인해 의료자원 공급이 더욱 긴장되며, 사람들은 더욱 자기 자신과 타인을 유형화하려 함. 그러나 인간은 매우 복잡한 존재로서 각자 아주 독특하고 심오한 사고, 욕구, 성격, 행동 패턴을 지니고 있으며, 이러한 복잡함 자체가 가치 있음->이런 상황에 환자의 주도성을 높이는 것이 핵심일 것임
